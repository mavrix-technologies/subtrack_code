...
const endTarget = '<!-- Detailed Features Grid -->';

const startIndex = html.indexOf(startTarget);
const endIndex = html.indexOf(endTarget);

if (startIndex !== -1 && endIndex !== -1) {
  console.log('Found targets at positions:', startIndex, endIndex);
...
\n  `;
  ...
  const finalHtml = before + cleanScreensHtml + after;
  fs.writeFileSync(filePath, finalHtml, 'utf8');
  console.log('Successfully completed full visual reconstruction!');
} else {
  console.error('Failed to locate targets!');
}
